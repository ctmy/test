	        ...
	        <div class="item">
				...
				<div class="r">
		            ...
		            <div class="p-foot">
						...
						<button {if $v['posts']}style="color: #ef6464;"{/if} id="post--start-{$v.pid}" class="btn btn-link" data-str0="默认排序" data-str1="{$_LANG['最新回复']}" data-sort="0" data-posts="{$v.posts}" data-state="hide" data-pid="{$v.pid}" onclick="show_post_post_box(this)">
                        	<i class="iconfont icon-commentalt2fill"></i> {if $v['posts']}{$v.posts} 条评论{else}回复帖子{/if}
                        </button>
